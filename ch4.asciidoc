...
====
*Wenn du durch feindseliges Gebiet reist,* wähle unter deinen Gefährten einen _Vorreiter_, einen _Kundschafter_ und einen _Quartiermeister_ aus.
...
✴ Bei einer 7–9 vollführen deine Gefährten ihren Job, wie man es erwarten würde:
...
Wenn ihr nicht genug Leute seid oder nicht alle Aufgaben verteilen wollt, werden die nicht zugewiesenen Aufgaben als Fehlschlag (6-) behandelt.
...
Wenn du im Laufe dieser Sitzung wenigstens einmal entspreched deiner Gesinnung gehandelt hast, schreibe dir einen EP gut.
Dann beantwortet folgende Fragen in der Gruppe:

* Haben wir etwas Neues und Wesentliches über die Welt in Erfahrung gebracht?
...
.Stufe aufsteigen
====
*Wenn du dir eine Auszeit von mehreren Stunden oder Tagen nehmen kannst und mindestens `Stufe + 7` EP hast,* kannst du über deine Erfahrungen reflektieren und deine Fähigkeiten vervollkommnen.
...
Das Ändern deiner Konstitution verändert außerdem deine maximalen und momentanen TP.
Attribute können bis auf einen Wert von 18 gesteigert werden.
====
...
✴ Bei einer 6- wähle ebenfalls 1, aber die Sache wird richtig aus dem Ruder laufen – der SL beschreibt dir, wie.
...
Der Sieg ist das, was die Bewunderer dazu bringt, sich um Abenteurer zu scharen, wenn diese ihren neuesten Beutezug feiern.
Wenn du deinen Sieg nicht bekannt machst, wer würde dann schon mit dir zechen wollen?
...
Wenn sie etwas besonderes ist – etwas, was verzaubert oder hier normalerweise nicht erhältlich ist –, würfle+CHA.
...
Wenn du unter der Pflege eines Heilers stehst – magisch oder mondän –, darfst du stattdessen alle zwei Ruhetage eine Beeinträchtigung entfernen.
====
...
* +1, wenn du bekanntgibst, dass er/sie an der Beute beteiligt wird/werden,
...
✴ Bei einer 7–9 wirst du dich mit jemandem begnügen müssen, der/die deinen Anforderungen nur teilweise entspricht/entsprechen.
