...
Wenn du den Antworten entsprechend handelst, bekommst du +1 vorwärts.
...
Solange in einem Move nichts anderes behauptet wird, kannst du nur die Fragen an den SL richten, die in der Liste erscheinen.
...
Solange er das beantworten kann, löst er den Move aus.
...
Solange ein Spieler erklären kann, auf welche Art und Weise er bei einem Move helfen will und die Erklärung Sinn macht, gestatte ihm seinen _Helfen_-Wurf.
...
Spezielle Moves sind solche, die im Spielverlauf weniger häufig oder nur in bestimmten Situationen auftreten.
...
Der Move kann drei Auswirkungen haben.
...
.Belastung
****
*Wenn du einen Move auslöst, während du Gewicht mit dir herumträgst,* kann sich diese Belastung nachteilig auswirken.
Wenn du…
...
Dieser Move trifft nur auf Gegenstände zu, mit denen du normal herumlaufen und trotzdem noch agieren kannst.
...
Stattdessen beeinflusst es, welche Moves du in der Fiktion auslösen kannst.
...
✴ Bei einer 10+ gelingt es dir, das Lager zu wecken und bereitzumachen; jeder im Lager erhält +1 vorwärts.
