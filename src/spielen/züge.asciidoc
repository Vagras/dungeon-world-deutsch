...
Wenn du den Antworten entsprechend handelst, nimm +1 voraus.
...
* bis zu deiner Traglast+2 mit dir trägst, nimm -1 fortlaufend, bis du dich von deiner Last befreist.
...
Wenn du ihn abweist, nimm -1 voraus auf _Anwerben_.
